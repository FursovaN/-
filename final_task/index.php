...
<?php if ($user): ?>
<a href="feedback.php">✍️ Оставить отзыв</a>
...
<p>Чтобы оставить отзыв или посмотреть историю сообщений, пожалуйста, <a href="login.php">войдите</a> или <a
href="register.php">зарегистрируйтесь</a>.</p>
</div>
